...
int state=LOW;          //variable for pir case
int count = 0;          //variable to write the password in the correct way
int varD=0;             //shared varDiable for display task
char str;               //password insert
int varSensor=0;        //variable to synchronize the sensor threads
...
void setup() {
  ...
  xTaskCreate(Thread_ON, "Thread_ON", 100, NULL, 2, NULL);
  xTaskCreate(Thread_PIR, "Thread_PIR", 100, NULL, 1, NULL);
  xTaskCreate(Thread_BUZZER, "Thread_BUZZER", 100, NULL, 2, NULL);
  xTaskCreate(Thread_KEYBOARD, "Thread_KEYBOARD", 100, NULL, 2, NULL);
  xTaskCreate(Thread_WINDOWS, "Thread_WINDOWS", 100, NULL, 1, NULL);
  xTaskCreate(Thread_BALCONY, "Thread_BALCONY", 100, NULL, 1, NULL);
  xTaskCreate(Thread_DISPLAY, "Thread_DISPLAY", 100, NULL, 2, NULL);
